 ...
 * Template name: add-advert-apartment
...
<div class="main-content-container">
    ...
    <div class="content-container-wrapper">
        ...
        <section id="add-advert" class="add-advert">

            <h2 class="add-advert_title">Ajouter une annonce</h2>

            <!-- addr input -->
            <div class="add-advert_top-row">
            ...
            <div  id="type" class="add-advert_type flex-type">
            ...
            <div id="input_wrap">
                ...
                <div class="flex-type_top">
                    ...
                    <h3 class="checkbox-list_title">Ascenseur:</h3>

                    <div class="add-advert_icon">

                        <img src="/wp-content/uploads/2019/04/prof_elevator.png" alt="kitchen">

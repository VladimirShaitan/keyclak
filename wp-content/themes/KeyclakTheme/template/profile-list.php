...
<div class="main-content-container">
    <header class="sub-header profile-list">
        <span class="sub-title-page">Mes biens loués</span>
    ...
    <div class="content-container-wrapper">
        ...
        <div class="profile-wrapper profile-list">
            <div class="profile-title">Appartment 1</div>
        ...
        <div class="profile-wrapper profile-list">
            <div class="profile-title">Appartment 2</div>
            <div class="profile-info-container">
                <div class="profile-photo-container">
                    <div class="user-profile-photo">
                        <img src="/wp-content/uploads/2019/03/user-pic.png" alt="">

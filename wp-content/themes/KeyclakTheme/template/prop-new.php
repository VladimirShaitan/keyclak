...
Template name: Propriétaire-New
...
<div class="main-content-container propriétaire-bg ">
    ...
    <div class="content-container-wrapper register-page">
        <div class="login-page-container">
            ...
            <div class="middle-content-container">
                <div class="left-content">
                    <div class="text-container">
                        ...
                        N'attendez plus et <a href="http://keyclak.html-studio.net/proprietaire-registration/"><b>cliquez ici</b></a>
                        pour commencer l'expérience
                        <div class="p-facebook-under-form">
                            S’inscrire avec <i class="icon facebook"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="right-content">
                    <div class="text-container">
                        ...
                        <form class="se-connecter-form propriétaire">
            ...
            <div class="subtitle">Vivez une nouvelle expérience de location immobilière !</div>
        </div>
    </div>
</div>

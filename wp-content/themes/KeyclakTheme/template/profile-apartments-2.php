...
Template name: Profile Apartments-2
...
<div class="main-content-container">
    <header class="sub-header profile-apartments">
        <span class="sub-title-page">Studio, Paris 14</span>
    </header>
        ...
        <div class="apartments-info-wrapper">
            ...
            <div class="right-info-container">
                <ul class="main-list">
                    ...
                    <li>
                        <div class="icons-wrap"><i class="icon tree"></i></div>
                        <div class="apartment-info">
                    ...
                    <li class="last-child">
                        <div class="icons-wrap"><i class="icon question"></i></div>
                        <div class="apartment-info">
                    ...
                    <ul class="sub-list">
                        <li>
                            <div class="static">ERNMT :</div>
                            <span>Oui</span>
                        </li>
                        <li>
                            <div class="static">DPE :</div>
                            <div class="rating rat-a">A</div>
                        </li>
                        <li>
                            <div class="static">Electricité/Gaz :</div>
                            <div class=" rating rat-d">D</div>
                        </li>
                    </ul>

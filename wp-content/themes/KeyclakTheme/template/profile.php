                    ...
                    <div class="profile-main-data">
                        <ul>
                            <li>
                                ...
                                <input class="right-side user-field" type="text" readonly value="<?php echo $user_meta['first_name'][0]; ?>">
                            </li>
                            <li>
                                <div class="left-side">Prénom</div>
                                <input class="right-side user-field" type="text" readonly value="<?php echo $user_meta['last_name'][0]; ?>">
                            </li>
                            <li>
                                <div class="left-side">Adresse e-mail</div>
                                <input class="right-side user-field" type="email" readonly value="<?php echo $user_data->data->user_email; ?>">
                            </li>
                            <li>
                                <div class="left-side">Numéro de téléphone</div>
                                <input class="right-side user-field" type="tel" readonly value="<?php echo $user_meta['phone'][0]; ?>">
                            </li>
                            <li>
                                <div class="left-side">Mot de passe</div>
                                <input class="right-side user-field" type="password" readonly value="<?php echo base64_decode($user_meta['pwd'][0]); ?>">
                            </li>
                            <li>

...
<div class="ere-register-wrap">
    ...
    <form class="ere-register inscription-form" method="post" enctype="multipart/form-data">
        <div class="form-group control-username input-main">
            <label>Nom</label>
            <input name="user_login" class="form-control control-icon" type="text" placeholder="" />
        </div>
        <div class="form-group control-email input-main">
            <label>Adresse email</label>
            <input name="user_email" type="email" class="form-control control-icon" placeholder=""/>
        </div>

        <?php if ($enable_password) { ?>
            <div class="form-group control-password input-main">
                <label>Mot de passe</label>
                <input name="user_password" class="form-control control-icon" type="password" placeholder=""/>
            </div>
            <div class="form-group control-ere-password input-main last-input">
                <label>Confirmation mot de passe</label>
                <input name="user_password_retype" class="form-control control-icon" type="password" placeholder=""/>
            </div>
        ...
        <div class="inscription-form-submit">
            <button type="submit" data-redirect-url="<?php echo esc_url($redirect_url); ?>"
                class="submit-btn-green ere-register-button btn btn-primary btn-block">Inscription</button>
        </div>
    </form>
</div>
